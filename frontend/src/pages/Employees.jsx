...
export default function Employees() {
  ...
  async function handleDelete() {
    ...
    setDeleting(true);
    try {
      await api.deleteEmployee(confirmDelete.employee_id);
      toast(`${confirmDelete.full_name} removed`, "success");
        ...
        <table>
          ...
          <tbody>
            {loading ? (
              ...
              // API returns snake_case: id, employee_id, full_name, email, department, total_present
              const av = avatarColor(emp.full_name);
              const pct = Math.min(100, ((emp.total_present || 0) / 30) * 100);
              return (
                <tr key={emp.id}>
                  <td>
          ...
          <div className="modal confirm-modal">
            ...
            <div className="modal-body">
              ...
              <div className="confirm-desc">
                This will permanently remove <strong style={{ color: "var(--text)" }}>{confirmDelete.full_name}</strong> and all their attendance records. This action cannot be undone.
              </div>
              <div className="modal-footer">
